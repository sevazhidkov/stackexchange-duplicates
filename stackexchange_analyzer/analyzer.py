...
QUESTION_LINK = "http://{domain}/questions/{id}/"
...
class Analyzer:
    ...
    def __init__(self, posts_path, posts_links_path, posts_num, domain):
        ...
        # Domain of StackExchange site. By default, it's domain of
        # DBA StackExchange community
        self.domain = domain
        ...
        for result_post in self.top_duplicated_posts:
            ...
            for post in result_posts_data:
                if post['Id'] == result_post[0]:
                    ...
                    post_summary['url'] = QUESTION_LINK.format(
                        domain=self.domain, id=post['Id']
                    )
                    break
            ...
            for duplicate_id in result_post[1]:
                for post in result_posts_data:
                    if post['Id'] == duplicate_id:
                        ...
                        duplicate_summary['url'] = QUESTION_LINK.format(
                            domain=self.domain, id=post['Id']
                        )
